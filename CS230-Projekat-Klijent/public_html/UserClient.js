...
// Model for User entity
    models.User = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/CS230-Projekat/webresources/com.cs230.projekat.user/",
        idAttribute: 'userId',
        defaults: {
            lastName: "",
            address: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/CS230-Projekat/webresources/com.cs230.projekat.user/';
            }
    ...
    models.UserCollection = Backbone.Collection.extend({
        model: models.User,
        url: "http://localhost:8080/CS230-Projekat/webresources/com.cs230.projekat.user/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
